...
public class main extends AppCompatActivity {
    ...
    protected void onNewIntent(Intent intent) {
        ...
        FirebaseDatabase.getInstance().getReference("FIREBASE DATA").child(email)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        System.out.println("DATASNALSHOT: "+dataSnapshot.getValue());
                        FirebaseDatabase.getInstance().getReference("TEMP DATA").child(email).setValue(dataSnapshot.getValue());
                      //  FirebaseDatabase.getInstance().getReference("TEMP DATA").child(email).child("Contacts").setValue(null);
        ...
        FirebaseDatabase.getInstance().getReference().child("TEMP DATA")
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    if (!snapshot.getValue().equals("")&&!snapshot.getKey().equals(email)) {
                ...
                firebase.child(email.toLowerCase()).child("zContacts").child(identity).setValue("");
